...
class Create_user: 
    ...
    def __init__(self):
        ...
        self.txt_Nome = ctk.CTkEntry(self.frame1, textvariable=self.nome, font=ctk.CTkFont("CENTURY GOTHIC", 16), width=130)
        self.txt_Nome.pack(padx=10, pady=10)

        self.label_Senha = ctk.CTkLabel(self.frame1, text="Senha", fg_color="#535c68", font=ctk.CTkFont("CENTURY GOTHIC", 16), text_color="white")
        self.label_Senha.pack(padx=10, pady=10)
        self.txt_Senha = ctk.CTkEntry(self.frame1, textvariable=self.senha, font=("CENTURY GOTHIC", 16), width=130, show="*")
        ...
        self.label_Nivel_acesso.pack(padx=10, pady=10)
        self.txt_Nivel_acesso= ctk.CTkEntry(self.frame1, textvariable=self.nivel_acesso, font=ctk.CTkFont("CENTURY GOTHIC", 16), width=130)
        ...
        self.btnAdd = ctk.CTkButton(self.frame2, text="Adicionar", width=15, font=ctk.CTkFont("CENTURY GOTHIC", 16, "bold"), text_color="white", fg_color="#16a085", command = self.inserir_funcionario)
        self.btnAdd.pack(padx=10)
    
        self.btnEdit = ctk.CTkButton(self.frame2, text="Editar", width=15, font=ctk.CTkFont("CENTURY GOTHIC", 16, "bold"), text_color="white", fg_color="#2980b9", command = self.editar_funcionario)
        self.btnEdit.pack(padx=10)

        self.btnDel = ctk.CTkButton(self.frame2, text="Deletar", width=15, font=ctk.CTkFont("CENTURY GOTHIC", 16, "bold"), text_color="white", fg_color="#16a085", command = self.del_funcionario)
        self.btnDel.pack(padx=10)

        self.btnClear = ctk.CTkButton(self.frame2,  text="Limpar Campos", width=15, font=ctk.CTkFont("CENTURY GOTHIC", 16, "bold"), text_color="white", fg_color="#f39c12", command = self.clearAll)
        ...
        self.table_frame=ctk.CTkFrame(self.frame3, bg_color="white")
        ...
        self.table.heading("3", text="SENHA")
